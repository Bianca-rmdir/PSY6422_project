---
title: "Leading Causes of CO2 Emissions and Correlations Between Them"
...
```{r worldmaps, echo=TRUE, message = FALSE, warning = FALSE}

#store world coordinates in a variable
...
#save map
#ggsave("map_co2.png", plot = map_co2, device = "png")
...
map_airtravel <- ggplot(combinedcoord) + 
  geom_polygon(aes(long,lat, 
                   ...
                   text = paste("Country: ", country, 
                                "<br> Air Travel: ", airtravel_per1000)),
               color = "black",
               size = 0.1)+
  scale_fill_gradient(low = "white", 
                      high = "red") +
...
#convert map to plotly object
airtravel_plotly <- ggplotly(map_airtravel, 
                             tooltip = "text")

#save map
#ggsave("map_airtravel.png", plot = map_airtravel, device = "png")


#create map for meat production
map_meatprod <- ggplot(combinedcoord) + 
  geom_polygon(aes(long,lat, 
                   group=group, 
                   fill=meat_per1000,
                   text = paste("Country: ", country, 
                                "<br> Meat Production: ", meat_per1000)),
               color = "black",
               size = 0.1)+
  scale_fill_gradient(low = "white", 
                      high = "red") +
...
#convert map to plotly object
meatprod_plotly <- ggplotly(map_meatprod, 
                            tooltip = "text")

#save map
#ggsave("map_meatprod.png", plot = map_meatprod, device = "png")
...
map_milkprod <- ggplot(combinedcoord) + 
  geom_polygon(aes(long,lat, 
                   ...
                   fill=milk_per1000,
                   text = paste("Country: ", country, 
                                "<br> Milk Production: ", milk_per1000)),
               color = "black",
               size = 0.1)+
  scale_fill_gradient(low = "white", 
                      high = "red") +
...
#convert map to plotly object
milkprod_plotly <- ggplotly(map_milkprod, 
                            tooltip = "text")

#save map
#ggsave("map_milkprod.png", plot = map_milkprod, device = "png")


#create map for plastic pollution
map_plasticpol <- ggplot(combinedcoord) + 
  geom_polygon(aes(long,lat, 
                   group=group, 
                   fill=plastic_pol_per1000,
                   text = paste("Country: ", 
                                country, "<br> Plastic Pollution: ", plastic_pol_per1000)),
               color = "black",
               size = 0.1)+
  scale_fill_gradient(low = "white", 
                      high = "red") +
  theme_void() + 
  labs (title = "Plastic waste discarded into the ocean per 1000 people measured in kilograms")+
  theme(plot.background = element_rect(fill = "white")) +
  coord_equal()


#convert map to plotly object
plasticpol_plotly <- ggplotly(map_plasticpol, 
                              tooltip = "text")


#save map
#ggsave("map_plasticpol.png", plot = map_plasticpol, device = "png")
...
#####make a scatterplot for co2 and air travel
scatter_co_air <- 
  ggplot(combinedcoord, aes(airtravel_per1000, co2_per1000, 
                            text = paste("Country:", country, "<br>",
                          "Air Travel (km):", airtravel_per1000, "<br>",
                          "CO2 Emissions (kt):", co2_per1000))) +  
  geom_point(aes(color= co2_per1000)) +
  scale_color_gradient(low = "grey", 
                       high = "black") +
  labs(title = "The relationship between CO2 emissions and air travel",
       x = "Air Travel (km)",
       y = "CO2 Emissions (kt)") +
  theme_light()

#transform scatterplot into plotly object
scatter_co_air_plotly <- ggplotly(scatter_co_air, 
                                  tooltip = "text") 
#save plot
#ggsave("scatter_co2_airtravel.png", plot = scatter_co_air, device = "png")


######make a scatterplot for co2 and meat production
scatter_co_meat <- 
  ggplot(combinedcoord, aes(meat_per1000, co2_per1000,
                            text = paste("Country:", country, "<br>",
                          "Meat Production (t):", meat_per1000, "<br>",
                          "CO2 Emissions (kt):", co2_per1000))) +  
  geom_point(aes(color= co2_per1000)) +
  scale_color_gradient(low = "green", 
                       high = "red") +
  labs(title = "The relationship between CO2 emissions and meat production",
       x = "Meat Production (t)",
       y = "CO2 Emissions (kt)") +
  theme_light()

#transform scatterplot into plotly object
scatter_co_meat_plotly <- ggplotly(scatter_co_meat, 
                                  tooltip = "text") 
#save plot
#ggsave("scatter_co2_meat.png", plot = scatter_co_meat, device = "png")

######make a scatterplot for co2 and milk production
scatter_co_milk <- 
  ggplot(combinedcoord, aes(milk_per1000, co2_per1000,
                            text = paste("Country:", country, "<br>",
                          "Milk Production (t):", milk_per1000, "<br>",
                          "CO2 Emissions (kt):", co2_per1000))) +  
  geom_point(aes(color= co2_per1000)) +
  scale_color_gradient(low = "cyan", 
                       high = "blue") +
  labs(title = "The relationship between CO2 emissions and milk production",
       x = "Milk Production (t)",
       y = "CO2 Emissions (kt)") +
  theme_light()

#transform scatterplot into plotly object
scatter_co_milk_plotly <- ggplotly(scatter_co_milk, 
                                  tooltip = "text") 
#save plot
#ggsave("scatter_co2_milk.png", plot = scatter_co_milk, device = "png")

######make a scatterplot for co2 and plastic pollution
scatter_co_plastic <- 
  ggplot(combinedcoord, aes(plastic_pol_per1000, co2_per1000,
                            text = paste("Country:", country, "<br>",
                          "Plastic Pollution (kg):", plastic_pol_per1000, "<br>",
                          "CO2 Emissions (kt):", co2_per1000))) +  
  geom_point(aes(color= co2_per1000)) +
  scale_color_gradient(low = "blue", 
                       high = "red") +
  labs(title = "The relationship between CO2 emissions and plastic pollution",
       x = "Plastic Pollution (kg)",
       y = "CO2 Emissions (kt)") +
  theme_light()

#transform scatterplot into plotly object
scatter_co_plastic_plotly <- ggplotly(scatter_co_plastic, 
                                  tooltip = "text") 
#save plot
#ggsave("scatter_co2_plastic.png", plot = scatter_co_plastic, device = "png")

#######################PLOTS FOR RESEARCH QUESTION 3####################################################

######make a scatterplot for air travel and meat production
scatter_air_meat <- 
  ggplot(combinedcoord, aes(airtravel_per1000, meat_per1000,
                            text = paste("Country:", country, "<br>",
                          "Air Travel (km):", airtravel_per1000, "<br>",
                          "Meat Production (t):", meat_per1000, "<br>",
                          "CO2 Emissions (kt):", co2_per1000))) +  
  ...
  scale_color_gradient(low = "green", 
                       high = "red") +
  labs(title = "The relationship between air travel and meat production",
       x = "Air Travel (km)",
       y = "Meat Production (t)") +
  theme_light()

#transform scatterplot into plotly object
scatter_air_meat_plotly <- ggplotly(scatter_air_meat, 
                                  tooltip = "text") 
#save plot
#ggsave("scatter_air_meat.png", plot = scatter_air_meat, device = "png")

######make a scatterplot for air travel and milk production
scatter_air_milk <- 
  ggplot(combinedcoord, aes(airtravel_per1000, milk_per1000,
                            text = paste("Country:", country, "<br>",
                          "Air Travel (km):", airtravel_per1000, "<br>",
                          "Milk Production (t):", milk_per1000, "<br>",
                          "CO2 Emissions (kt):", co2_per1000))) +  
  ...
  scale_color_gradient(low = "green", 
                       high = "red") +
  labs(title = "The relationship between air travel and milk production",
       x = "Air Travel (km)",
       y = "Milk Production (t)") +
  theme_light()

#transform scatterplot into plotly object
scatter_air_milk_plotly <- ggplotly(scatter_air_milk, 
                                  tooltip = "text") 
#save plot
#ggsave("scatter_air_milk.png", plot = scatter_air_milk, device = "png")

######make a scatterplot for air travel and plastic pollution
scatter_air_plastic <- 
  ggplot(combinedcoord, aes(airtravel_per1000, plastic_pol_per1000,
                            text = paste("Country:", country, "<br>",
                          "Air Travel (km):", airtravel_per1000, "<br>",
                          "Plastic Pollution (kg):", plastic_pol_per1000, "<br>",
                          "CO2 Emissions (kt):", co2_per1000))) +  
  ...
  scale_color_gradient(low = "green", 
                       high = "red") +
  labs(title = "The relationship between air travel and plastic pollution",
       x = "Air Travel (km)",
       y = "Plastic Pollution (kg)") +
  theme_light()

#transform scatterplot into plotly object
scatter_air_plastic_plotly <- ggplotly(scatter_air_plastic, 
                                  tooltip = "text") 
#save plot
#ggsave("scatter_air_plastic.png", plot = scatter_air_plastic, device = "png")

#make a scatterplot for meat production and milk production
scatter_meat_milk <- 
  ggplot(combinedcoord, aes(meat_per1000, milk_per1000,
                            text = paste("Country:", country, "<br>",
                          "Meat Production (t):", meat_per1000, "<br>",
                          "Milk Production (t):", milk_per1000, "<br>",
                          "CO2 Emissions (kt):", co2_per1000))) +  
  ...
  scale_color_gradient(low = "green", 
                       high = "red") +
  labs(title = "The relationship between meat production and milk production",
       x = "Meat Production (t)",
       y = "Milk Production (t)") +
  theme_light()

#transform scatterplot into plotly object
scatter_meat_milk_plotly <- ggplotly(scatter_meat_milk, 
                                  tooltip = "text") 
#save plot
#ggsave("scatter_meat_milk.png", plot = scatter_meat_milk, device = "png")

#make a scatterplot for meat production and plastic pollution
scatter_meat_plastic <- 
  ggplot(combinedcoord, aes(meat_per1000, plastic_pol_per1000,
                            text = paste("Country:", country, "<br>",
                          "Meat Production (t):", meat_per1000, "<br>",
                          "Plastic Pollution (kg):", plastic_pol_per1000, "<br>",
                          "CO2 Emissions (kt):", co2_per1000))) +  
  ...
  scale_color_gradient(low = "green", 
                       high = "red") +
  labs(title = "The relationship between meat production and plastic pollution",
       x = "Meat Production (t)",
       y = "Plastic Pollution(kg)") +
  theme_light()

#transform scatterplot into plotly object
scatter_meat_plastic_plotly <- ggplotly(scatter_meat_plastic, 
                                  tooltip = "text") 
#save plot
#ggsave("scatter_meat_plastic.png", plot = scatter_meat_plastic, device = "png")

#make a scatterplot for milk production and plastic pollution
scatter_milk_plastic <- 
  ggplot(combinedcoord, aes(milk_per1000, plastic_pol_per1000,
                            text = paste("Country:", country, "<br>",
                          "Milk Production (t):", milk_per1000, "<br>",
                          "Plastic Pollution (kg):", plastic_pol_per1000, "<br>",
                          "CO2 Emissions (kt):", co2_per1000))) +  
  ...
  scale_color_gradient(low = "green", 
                       high = "red") +
  labs(title = "The relationship between milk production and plastic pollution",
       x = "Milk Production (t)",
       y = "Plastic Pollution(kg)") +
  theme_light()

#transform scatterplot into plotly object
scatter_milk_plastic_plotly <- ggplotly(scatter_milk_plastic, 
                                  tooltip = "text") 
#save plot
#ggsave("scatter_milk_plastic.png", plot = scatter_milk_plastic, device = "png")
...
```{r dashboard output, include=FALSE}
...
ui <- dashboardPage(
  ...
  sidebar = dashboardSidebar(
    sidebarMenu(
      ...
      menuItem("Full Code", tabName = "tab6")
    )
  ),
  body = dashboardBody(
    tabItems(
